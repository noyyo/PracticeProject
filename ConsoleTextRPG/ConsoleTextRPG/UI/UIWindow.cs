...
namespace ConsoleTextRPG.UI
{
    ...
    public class UIWindow : IDrawable
    {
        ...
        public int Width;
        public int Height;
        private const ConsoleColor _focusColor = ConsoleColor.DarkGray;
        protected UIComponent? _focusedComponent;
        ...
        public virtual void OpenWindow()
        {
            ...
            UIComponent? firstComp = Components.Find(component => component.IsFocusable == true);
            if (firstComp == null)
                return;
